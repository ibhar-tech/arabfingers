...
export default function sitemap(): MetadataRoute.Sitemap {
  return [
    ...
    { url: `${siteUrl}/en/learn/arabic-numbers`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.8, alternates: { languages: { ar: `${siteUrl}/ar/learn/arabic-numbers` } } },
    { url: `${siteUrl}/en/learn/arabic-colors`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.8, alternates: { languages: { ar: `${siteUrl}/ar/learn/arabic-colors` } } },
    { url: `${siteUrl}/en/learn/first-arabic-words`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.8, alternates: { languages: { ar: `${siteUrl}/ar/learn/first-arabic-words` } } },
