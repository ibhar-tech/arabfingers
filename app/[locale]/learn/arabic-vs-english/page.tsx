...
function ContentEn() {
  return (
    <>
      ...
      <p className="text-sm text-white/55 mb-8">A parent-friendly comparison to help you understand both writing systems</p>
      ...
      <div className="space-y-8 text-sm leading-relaxed text-white/80">
        ...
        <section>
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              <thead><tr className="border-b border-white/10"><th className="py-2 px-3 text-left text-white/70 font-medium">Feature</th><th className="py-2 px-3 text-left text-white/70 font-medium">Arabic</th><th className="py-2 px-3 text-left text-white/70 font-medium">English</th></tr></thead>
              <tbody className="text-white/75">
                <tr className="border-b border-white/5"><td className="py-2 px-3 text-white/85 font-medium">Direction</td><td className="py-2 px-3">Right to left (RTL)</td><td className="py-2 px-3">Left to right (LTR)</td></tr>
                <tr className="border-b border-white/5"><td className="py-2 px-3 text-white/85 font-medium">Letters</td><td className="py-2 px-3">28 letters</td><td className="py-2 px-3">26 letters</td></tr>
                <tr className="border-b border-white/5"><td className="py-2 px-3 text-white/85 font-medium">Do shapes change?</td><td className="py-2 px-3">Yes — up to 4 forms per letter</td><td className="py-2 px-3">No — same shape everywhere</td></tr>
                <tr className="border-b border-white/5"><td className="py-2 px-3 text-white/85 font-medium">Capital letters</td><td className="py-2 px-3">None</td><td className="py-2 px-3">Uppercase + lowercase</td></tr>
                <tr className="border-b border-white/5"><td className="py-2 px-3 text-white/85 font-medium">Script style</td><td className="py-2 px-3">Always cursive (connected)</td><td className="py-2 px-3">Print or cursive</td></tr>
                <tr className="border-b border-white/5"><td className="py-2 px-3 text-white/85 font-medium">Vowels</td><td className="py-2 px-3">3 long-vowel letters + optional marks</td><td className="py-2 px-3">5 vowel letters (A, E, I, O, U)</td></tr>
                <tr className="border-b border-white/5"><td className="py-2 px-3 text-white/85 font-medium">Dots</td><td className="py-2 px-3">Dots distinguish many letters</td><td className="py-2 px-3">Only i and j have dots</td></tr>
              </tbody>
            </table>
          </div>
        </section>
        ...
        <section>
          <h2 className="text-xl font-semibold text-white mb-3">2. Number of Letters</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold text-white mb-3">3. Letter Shapes Change with Position</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold text-white mb-3">4. No Capital Letters</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold text-white mb-3">5. Vowels Work Differently</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold text-white mb-3">6. The Role of Dots</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold text-white mb-3">7. Unique Sounds</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold text-white mb-3">What Transfers Easily — and What Needs Extra Practice</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="rounded-xl border border-emerald-400/20 bg-emerald-400/5 p-4">
              <h3 className="font-semibold text-emerald-200 mb-2">✓ Transfers easily</h3>
            ...
            <div className="rounded-xl border border-amber-400/20 bg-amber-400/5 p-4">
              <h3 className="font-semibold text-amber-200 mb-2">◐ Needs extra practice</h3>
              <ul className="list-disc list-inside space-y-1.5 text-white/80">
        ...
        <section>
          <h2 className="text-xl font-semibold text-white mb-3">Three Myths, Debunked</h2>
          <div className="space-y-3">
            <div className="rounded-xl border border-white/8 bg-white/5 p-4">
              <h3 className="font-semibold text-white mb-1">Myth: &quot;Arabic is too hard for young children.&quot;</h3>
              <p className="text-white/80">Children don&apos;t experience Arabic as &quot;hard&quot; — that&apos;s an adult feeling about an unfamiliar script. To a toddler, an Arabic letter is just another interesting shape with a sound attached, no harder than the Latin letters they also haven&apos;t learned yet. Early, playful exposure is what makes it feel easy.</p>
            </div>
            <div className="rounded-xl border border-white/8 bg-white/5 p-4">
              <h3 className="font-semibold text-white mb-1">Myth: &quot;Two scripts will confuse my child.&quot;</h3>
              <p className="text-white/80">Bilingual children build separate &quot;tracks&quot; for each language and switch between them naturally. A little temporary mixing is normal and passes. Two scripts don&apos;t cause confusion — they build flexibility.</p>
            </div>
            <div className="rounded-xl border border-white/8 bg-white/5 p-4">
              <h3 className="font-semibold text-white mb-1">Myth: &quot;You must learn all the diacritics before you can read.&quot;</h3>
              <p className="text-white/80">Early readers start with the letters themselves. Diacritics are added later, and fluent readers drop most of them entirely. A child can recognise and enjoy Arabic letters long before any vowel marks enter the picture.</p>
            </div>
          </div>
        </section>
...
function ContentAr() {
  return (
    <>
      <h1 className="text-3xl font-semibold text-white mb-2">الفرق بين الأبجدية العربية والإنجليزية</h1>
      <p className="text-sm text-white/55 mb-8">مقارنة مبسّطة تعينك على فهم نظامَي الكتابة ودعم طفلك</p>
      ...
      <div className="space-y-8 text-sm leading-relaxed text-white/80">
        ...
        <section>
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              <thead><tr className="border-b border-white/10"><th className="py-2 px-3 text-right text-white/70 font-medium">الميزة</th><th className="py-2 px-3 text-right text-white/70 font-medium">العربية</th><th className="py-2 px-3 text-right text-white/70 font-medium">الإنجليزية</th></tr></thead>
              <tbody className="text-white/75">
                <tr className="border-b border-white/5"><td className="py-2 px-3 text-white/85 font-medium">الاتجاه</td><td className="py-2 px-3">من اليمين إلى اليسار</td><td className="py-2 px-3">من اليسار إلى اليمين</td></tr>
                <tr className="border-b border-white/5"><td className="py-2 px-3 text-white/85 font-medium">عدد الحروف</td><td className="py-2 px-3">٢٨ حرفاً</td><td className="py-2 px-3">٢٦ حرفاً</td></tr>
                <tr className="border-b border-white/5"><td className="py-2 px-3 text-white/85 font-medium">هل تتغيّر الأشكال؟</td><td className="py-2 px-3">نعم — حتى أربعة أشكال للحرف</td><td className="py-2 px-3">لا — شكل واحد في كل موضع</td></tr>
                <tr className="border-b border-white/5"><td className="py-2 px-3 text-white/85 font-medium">الحرف الكبير</td><td className="py-2 px-3">لا يوجد</td><td className="py-2 px-3">كبير + صغير</td></tr>
                <tr className="border-b border-white/5"><td className="py-2 px-3 text-white/85 font-medium">نوع الخط</td><td className="py-2 px-3">متّصل دائماً</td><td className="py-2 px-3">مطبوع أو متّصل</td></tr>
                <tr className="border-b border-white/5"><td className="py-2 px-3 text-white/85 font-medium">الحركات</td><td className="py-2 px-3">٣ حروف مدّ + حركات اختيارية</td><td className="py-2 px-3">٥ أحرف علّة</td></tr>
                <tr className="border-b border-white/5"><td className="py-2 px-3 text-white/85 font-medium">النقاط</td><td className="py-2 px-3">تميّز كثيراً من الحروف</td><td className="py-2 px-3">في i وj فقط</td></tr>
              </tbody>
            </table>
          </div>
        </section>
        ...
        <section>
          <h2 className="text-xl font-semibold text-white mb-3">١. اتجاه الكتابة: من اليمين إلى اليسار</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold text-white mb-3">٢. عدد الحروف</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold text-white mb-3">٣. الحروف تتغيّر بتغيّر موضعها</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold text-white mb-3">٤. لا حرف كبير في العربية</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold text-white mb-3">٥. الحركات تعمل بطريقة مختلفة</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold text-white mb-3">٦. دور النقاط</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold text-white mb-3">٧. أصوات تنفرد بها العربية</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold text-white mb-3">ما الذي ينتقل بسهولة وما يحتاج تدريباً</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="rounded-xl border border-emerald-400/20 bg-emerald-400/5 p-4">
              <h3 className="font-semibold text-emerald-200 mb-2">✓ ينتقل بسهولة</h3>
              <ul className="list-disc list-inside space-y-1.5 text-white/80">
            ...
            <div className="rounded-xl border border-amber-400/20 bg-amber-400/5 p-4">
              <h3 className="font-semibold text-amber-200 mb-2">◐ يحتاج تدريباً</h3>
              <ul className="list-disc list-inside space-y-1.5 text-white/80">
        ...
        <section>
          <h2 className="text-xl font-semibold text-white mb-3">ثلاث خرافات نصحّحها</h2>
          <div className="space-y-3">
            <div className="rounded-xl border border-white/8 bg-white/5 p-4">
              <h3 className="font-semibold text-white mb-1">خرافة: &quot;العربية أصعب من أن يتعلّمها الصغار.&quot;</h3>
              <p className="text-white/80">الطفل لا يشعر بأنّ العربية &quot;صعبة&quot;؛ هذا إحساس الكبار تجاه خطٍّ غير مألوف لهم. أمّا الصغير فالحرف العربيّ عنده شكل لطيف له صوت، لا يزيد صعوبةً على الحروف اللاتينية التي لم يتعلّمها بعد. والتعريض المبكّر باللعب هو ما يجعلها سهلة.</p>
            </div>
            <div className="rounded-xl border border-white/8 bg-white/5 p-4">
              <h3 className="font-semibold text-white mb-1">خرافة: &quot;الخطّان سيربكان طفلي.&quot;</h3>
              <p className="text-white/80">يبني الطفل ثنائيّ اللغة &quot;مساراً&quot; مستقلاً لكلّ لغة وينتقل بينهما تلقائياً. والخلط اليسير في البداية أمر طبيعيّ يزول من نفسه. فالخطّان لا يسبّبان الارتباك، بل يبنيان المرونة.</p>
            </div>
            <div className="rounded-xl border border-white/8 bg-white/5 p-4">
              <h3 className="font-semibold text-white mb-1">خرافة: &quot;لا قراءة قبل إتقان الحركات كلّها.&quot;</h3>
              <p className="text-white/80">يبدأ المبتدئ بالحروف نفسها، والحركات تأتي لاحقاً، والقارئ المتمكّن يستغني عن أكثرها. والطفل يعرف الحروف العربية ويأنس بها قبل أن تدخل الحركات في حسابه بزمن.</p>
            </div>
          </div>
        </section>
