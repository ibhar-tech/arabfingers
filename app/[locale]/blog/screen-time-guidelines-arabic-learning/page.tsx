    ...
    <PageLayout locale={locale}>
      ...
      <Breadcrumbs
        ...
        crumbs={[
          ...
          { label: locale === "ar" ? "وقت الشاشة" : "Screen Time" },
        ]}
      />
    ...
    <>
      ...
      <div className="space-y-8 text-sm leading-relaxed text-white/80">
        <section>
          ...
          <p className="mb-3">
            The truth is nuanced: <strong className="text-white/90">not all screen time is created equal</strong>. Passively watching videos is fundamentally different from actively interacting with an educational app. And the context matters enormously — a child using an Arabic learning app alongside a parent who names the letters with them gets a vastly different experience from a child left alone with the same app.
          </p>
          <p>
        ...
        <section>
          <h2 className="text-xl font-semibold text-white mb-3">What the Research Actually Says</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold text-white mb-3">Active vs. Passive Screen Time</h2>
          <p className="mb-3">
            Researchers distinguish between <strong className="text-white/90">passive consumption</strong> (watching videos, scrolling) and <strong className="text-white/90">active interaction</strong> (responding to prompts, creating content, solving problems). The evidence consistently shows that active, interactive screen time produces better learning outcomes than passive viewing.
          </p>
          <p className="mb-3">
        ...
        <section>
          <h2 className="text-xl font-semibold text-white mb-3">Practical Guidelines for Arabic Learning Screen Time</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold text-white mb-3">The Bilingual Advantage in Screen Time Context</h2>
          <p className="mb-3">
    ...
    <>
      ...
      <div className="space-y-8 text-sm leading-relaxed text-white/80">
        <section>
          ...
          <p className="mb-3">
            الحقيقة دقيقة: <strong className="text-white/90">ليس كل وقت شاشة متساوياً</strong>. مشاهدة الفيديوهات بشكل سلبي مختلف جوهرياً عن التفاعل النشط مع تطبيق تعليمي. والسياق مهم للغاية — الطفل الذي يستخدم تطبيق تعلم عربية مع والد يسمّي الحروف معه يحصل على تجربة مختلفة تماماً عن الطفل المتروك وحده مع نفس التطبيق.
          </p>
          <p>في هذا الدليل، سنفصل ما تقوله الأبحاث فعلاً، ونقدم إرشادات عملية مخصصة لتعلم العربية.</p>
        </section>

        <section>
          <h2 className="text-xl font-semibold text-white mb-3">ما تقوله الأبحاث فعلاً</h2>
          <div className="space-y-4">
            <div className="rounded-xl border border-white/8 bg-white/5 p-5">
        ...
        <section>
          <h2 className="text-xl font-semibold text-white mb-3">إرشادات عملية لوقت الشاشة مع تعلم العربية</h2>
          <div className="space-y-4">
            <div className="rounded-xl border border-white/8 bg-white/5 p-4">
