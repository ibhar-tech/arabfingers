  ...
  return (
    <>
      ...
      <div className="space-y-8 text-sm leading-relaxed text-white/70">
        ...
        <section>
          <h2 className="text-xl font-semibold text-white mb-3">The Insight: Keyboard Smashing Is Learning</h2>
          <p className="mb-3">
            The realization that changed everything was simple: <strong className="text-white/90">toddlers already know how to use keyboards</strong>. They don&apos;t need instructions, tutorials, or onboarding flows. They smash keys. That&apos;s it. And every keypress is a learning opportunity — if you design the response correctly.
          </p>
          <p className="mb-3">
        ...
        <section>
          <h2 className="text-xl font-semibold text-white mb-3">Building the First Prototype</h2>
          <p className="mb-3">
        ...
        <section>
          <h2 className="text-xl font-semibold text-white mb-3">Design Decisions That Shaped ArabFingers</h2>
          <p className="mb-3">
            Every design decision in ArabFingers was guided by one principle: <strong className="text-white/90">what is best for a 1-3 year old?</strong> This led to some unconventional choices:
          </p>
        ...
        <section>
          <h2 className="text-xl font-semibold text-white mb-3">The Technical Architecture</h2>
          <p className="mb-3">
          ...
          <ul className="list-disc list-inside space-y-2 text-white/60">
            ...
            <li><strong className="text-white/80">Neural TTS</strong> — Letter pronunciations are generated using high-quality text-to-speech, providing natural-sounding Arabic and English letter names.</li>
          </ul>
          <p className="mt-3">
  ...
  return (
    <>
      ...
      <div className="space-y-8 text-sm leading-relaxed text-white/70">
        ...
        <section>
          <h2 className="text-xl font-semibold text-white mb-3">الرؤية: ضرب المفاتيح هو تعلم</h2>
          <p className="mb-3">
            الإدراك الذي غيّر كل شيء كان بسيطاً: <strong className="text-white/90">الأطفال الصغار يعرفون بالفعل كيف يستخدمون لوحات المفاتيح</strong>. لا يحتاجون تعليمات أو دروس تعريفية. هم يضغطون المفاتيح. هذا كل شيء. وكل ضغطة هي فرصة تعلم — إذا صممت الاستجابة بشكل صحيح.
          </p>
          <p className="mb-3">
        ...
        <section>
          <h2 className="text-xl font-semibold text-white mb-3">بناء النموذج الأولي</h2>
          <p className="mb-3">
        ...
        <section>
          <h2 className="text-xl font-semibold text-white mb-3">قرارات التصميم التي شكّلت عرب فنجرز</h2>
          <p className="mb-3">
            كل قرار تصميم في عرب فنجرز كان موجّهاً بمبدأ واحد: <strong className="text-white/90">ما هو الأفضل لطفل عمره ١-٣ سنوات؟</strong>
          </p>
          <div className="space-y-4">
            <div className="rounded-xl border border-white/8 bg-white/5 p-4">
