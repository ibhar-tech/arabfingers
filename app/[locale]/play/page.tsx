          ...
          {isAr ? (
            <>
              ...
              <div className="flex flex-wrap gap-3 text-sm">
                ...
                <Link href={`/${locale}/learn/arabic-alphabet-guide`} className="rounded-lg bg-accent/90 px-4 py-2 font-medium text-slate-950 hover:bg-accent transition">
                  دليل الأبجدية العربية الكامل
                </Link>
                <Link href={`/${locale}/coloring`} className="rounded-lg bg-white/10 px-4 py-2 font-medium text-white hover:bg-white/15 transition">
