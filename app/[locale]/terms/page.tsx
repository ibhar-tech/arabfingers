  ...
  return (
    <>
      ...
      <div className="mt-8 space-y-6 text-sm leading-relaxed text-ink/80">
        <section>
          <h2 className="mb-2 text-lg font-medium text-ink/90">Acceptance of Terms</h2>
          <p>By accessing and using ArabFingers, you agree to these terms. If you do not agree, please do not use the Service.</p>
        </section>
        <section>
          <h2 className="mb-2 text-lg font-medium text-ink/90">Description of Service</h2>
        ...
        <section>
          <h2 className="mb-2 text-lg font-medium text-ink/90">Use of Service</h2>
        ...
        <section>
          <h2 className="mb-2 text-lg font-medium text-ink/90">Intellectual Property</h2>
        ...
        <section>
          <h2 className="mb-2 text-lg font-medium text-ink/90">Advertisements</h2>
        ...
        <section>
          <h2 className="mb-2 text-lg font-medium text-ink/90">DMCA &amp; Copyright</h2>
        ...
        <section>
          <h2 className="mb-2 text-lg font-medium text-ink/90">Limitation of Liability</h2>
...
function TermsAr() {
  return (
    <>
      <h1 className="text-3xl font-semibold text-ink">شروط الاستخدام</h1>
      <p className="mt-1 text-sm text-ink/40">آخر تحديث: أبريل ٢٠٢٦</p>
      <div className="mt-8 space-y-6 text-sm leading-relaxed text-ink/80">
        <section>
          <h2 className="mb-2 text-lg font-medium text-ink/90">قبول الشروط</h2>
          <p>باستخدامك لتطبيق عرب فنجرز، فإنك توافق على شروط الاستخدام هذه. إذا كنت لا توافق، يرجى عدم استخدام الخدمة.</p>
        </section>
        <section>
          <h2 className="mb-2 text-lg font-medium text-ink/90">وصف الخدمة</h2>
        ...
        <section>
          <h2 className="mb-2 text-lg font-medium text-ink/90">استخدام الخدمة</h2>
        ...
        <section>
          <h2 className="mb-2 text-lg font-medium text-ink/90">إخلاء المسؤولية</h2>
