          ...
          <div className="flex items-center gap-2">
            ...
            {soundEnabled && (
              <button
                ...
                aria-label={isAr ? "إعادة النطق" : "Repeat the narration"}
                title={isAr ? "إعادة النطق" : "Repeat the narration"}
                className="flex h-11 w-11 items-center justify-center rounded-lg text-white/75 bg-white/10 hover:bg-white/15 cursor-pointer"
              >
          ...
          {activeScene.customGraphic === "intro" && (
            <div className="w-full h-full flex items-center justify-center gap-3 sm:gap-4 animate-fade-in px-2">
              ...
              <div className="text-center flex flex-col items-center justify-center min-w-0">
                <div className="hidden sm:block w-full sm:max-w-[300px] mb-2"><WaterCycleDiagram locale={locale} /></div>
                <h2 className="text-2xl sm:text-4xl font-extrabold bg-gradient-to-r from-accent via-cyan-300 to-blue-400 bg-clip-text text-transparent mb-1" style={{ fontFamily: "var(--font-ibm-plex-arabic), sans-serif" }}>
