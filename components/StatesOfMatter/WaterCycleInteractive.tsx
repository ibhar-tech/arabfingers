        ...
        <div className="relative z-10 flex-1 w-full px-6 flex items-center justify-center overflow-hidden">
          ...
          {activeScene.customGraphic === "intro" && (
            <div className="text-center flex flex-col items-center justify-center animate-fade-in">
              <div className="text-5xl sm:text-7xl mb-3 animate-bounce">💧☀️☁️</div>
              <h1 className="text-4xl sm:text-5xl font-extrabold bg-gradient-to-r from-accent via-cyan-300 to-blue-400 bg-clip-text text-transparent mb-2" style={{ fontFamily: "var(--font-ibm-plex-arabic), sans-serif" }}>
