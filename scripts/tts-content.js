/**
 * Shared content for every voiceover generator in this folder: the 28 letter names,
 * 12 colours, 11 numbers and the four course storyboards.
 *
 * The storyboards must stay in step with the scene arrays in
 * components/StatesOfMatter/*Interactive.tsx — scene ids map to
 * public/audio/<course>/scene_<id>_<lang>.mp3 by filename.
 */
...
module.exports = { courses, colors, numbers, letters };
